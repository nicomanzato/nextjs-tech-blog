...
const buttonVariants = cva(
  "inline-flex h-14 shrink-0 base-transition items-center justify-center whitespace-nowrap border-2 border-transparent px-7.5 text-lg font-base transition-colors outline-none select-none active:translate-y-px disabled:pointer-events-none disabled:translate-y-0",
  {
    variants: {
      variant: {
        primary:
        ...
        black:
          "bg-background-inverse text-text-icons-inverse hover:bg-background-brand hover:border-border-inverse hover:text-text-icons-primary focus-visible:border-border-brand focus-visible:ring-4 focus-visible:ring-border-brand/50 focus-visible:bg-background-brand focus-visible:text-text-icons-primary active:bg-background-brand active:text-text-icons-primary disabled:bg-transparent disabled:text-muted-foreground",
        "green-outline":
          "border-border-inverse bg-background-brand text-text-icons-primary hover:bg-background-inverse hover:text-text-icons-inverse focus-visible:bg-background-inverse focus-visible:text-text-icons-inverse active:bg-background-inverse active:text-text-icons-inverse disabled:border-transparent disabled:bg-transparent disabled:text-muted-foreground",
        transparent: "",
      },
    },
    defaultVariants: {
